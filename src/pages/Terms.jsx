...
const sections = [
  ...
  { title: "7. Moderação e Remoção de Conteúdo", content: "Reservamo-nos o direito de remover qualquer conteúdo que viole estes termos, sem aviso prévio. Contas reincidentes podem ser suspensas ou banidas permanentemente. Decisões de moderação podem ser contestadas pelo e-mail contato@pimpolhotv.com.br." },
