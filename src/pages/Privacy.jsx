...
const sections = [
  ...
  { title: "6. Seus Direitos (LGPD)", content: "Em conformidade com a Lei Geral de Proteção de Dados (LGPD - Lei 13.709/2018), você tem direito a: acessar seus dados, corrigir dados incorretos, solicitar a exclusão dos seus dados, revogar consentimento a qualquer momento. Para exercer esses direitos, entre em contato pelo e-mail: contato@cloudx.com.br" },
  ...
  { title: "8. Contato", content: "Dúvidas sobre esta política? Entre em contato: contato@cloudx.com.br ou pelo formulário na página de Contato." },
];
